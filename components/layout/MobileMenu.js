      ...
      >
        ...
        <div className="px-7">
          ...
          <ul className="space-y-10 cursor-pointer">
            <li className="border-t border-gray-600 pt-3">Home</li>
            <li className="border-t border-gray-600 pt-3">About Us</li>
            <li className="border-t border-gray-600 pt-3">Contech Us</li>
          </ul>
        </div>
      </div>
    </>
